...
var auth, changeDashboard, createGraph, dashboard, dataPoll, default_graphite_url, default_period, description,events, generateDataURL, generateEventsURL, generateGraphiteTargets, getTargetColor, graphScaffold, graphite_url, graphs, init, metrics, period, periodFrom, periodUntil, refresh, refreshSummary, refreshTimer, scheme, toggleCss, _avg, _formatBase1024KMGTP, _last, _max, _min, _sum;
...
dataPoll = function() {
  ...
  _results = [];
  period = "from=" + periodFrom + "&until=" + periodUntil;
...
graphScaffold = function() {
  ...
  var convertedPeriodFrom = new Date(periodFrom * 1000);
...
generateEventsURL = function(event_tags) {
  ...
  return "" + graphite_url + "/events/get_data?" + period + tags + jsonp;
};
...
Rickshaw.Graph.JSONP.Graphite = Rickshaw.Class.create(Rickshaw.Graph.JSONP, {
  ...
  addTotals: function(i) {
    ...
    return $(this.legend.lines[i].element).append("<a id=\"" + label + "\"></a><span class='totals pull-right'><i class='icon-caret-down'></i>: " + min + " <i class='icon-caret-up'></i>: " + max + " <i class='icon-sort'></i>: " + avg + "</span>");
  },
...
$('.timepanel').on('click', 'a.range', function() {
  ...
  periodFrom = "-" + $(this).attr('data-timeframe');
  periodUntil = "now"
  dataPoll();
...
$(window).bind('hashchange', function(e) {
  ...
  //period = "from=" + ((_ref = e.getState()) != null ? _ref.from : void 0) + "&until=" + ((_ref = e.getState()) != null ? _ref.until : void 0);
  periodFrom = ((_ref = e.getState()) != null ? _ref.from : void 0) || "-1h";
  periodUntil = ((_ref = e.getState()) != null ? _ref.until : void 0) || "now";
  description = ((_ref = e.getState()) != null ? _ref.description : void 0) || dashboard['description'];
  events = ((_ref = e.getState()) != null ? _ref.events : void 0) || "*" ;
  dataPoll();
